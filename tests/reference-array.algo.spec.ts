...
describe('ReferenceArray', () => {
  describe('constructor', () => {
    ...
    it('creates array with initial values', () => {
      const arr = new ReferenceArray<uint64>(Uint64(1), Uint64(2), Uint64(3))
  ...
  describe('index access', () => {
    it('throws on out of bounds access', () => {
      const arr = new ReferenceArray(1, 2)
  ...
  describe('slice()', () => {
    ...
    it('slices with start and end index', () => {
      const arr = new ReferenceArray(1, 2, 3, 4)
  ...
  describe('push() and pop()', () => {
    it('pushes items to end of array', () => {
      const arr = new ReferenceArray(1)
      arr.push(2, 3)
  ...
  describe('iteration', () => {
    ...
    it('provides entries() iterator', () => {
      const arr = new ReferenceArray('a', 'b')
