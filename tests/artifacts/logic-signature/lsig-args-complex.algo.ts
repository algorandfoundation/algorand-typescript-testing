...
import { assert, BigUint, Bytes, clone, LogicSig, op, Uint64 } from '@algorandfoundation/algorand-typescript'
...
export class SimpleStruct extends Struct<{ x: ARC4Uint64; y: ARC4Uint64 }> {}

export class NestedStruct extends Struct<{ header: Uint8; data: SimpleStruct }> {}

export class SimpleNamedTuple extends Struct<{ a: Uint8; b: ARC4Uint64 }> {}

export class OverwriteStruct extends Struct<{ value: Uint8; dontOverwriteMe: Bool }> {}

export class ArgsComplex extends LogicSig {
  program(
    arg0: uint64,
    arg1: bytes,
    arg2: biguint,
