...
describe('FixedArray', () => {
  describe('constructor', () => {
    ...
    //   const arr = new FixedArray<uint64, 3>(Uint64(1), Uint64(2), Uint64(3))
  ...
  //     const arr = new FixedArray(1, 2, 3, 4)
  ...
  //     const original = new FixedArray(1, 2, 3)
