---
title: Transactions
description: Model transaction groups, scopes, and inner transaction behavior.
---
...
- [ApplicationSpy](../building/application-spy/) for detailed explanation on the usage of it
