...
description: Understand the core testing model and capabilities of the framework.
---
...
- [Smart Contract Testing](../building/contract-testing/)
- [Smart Signature Testing](../building/signature-testing/)
- [State Management](../building/state-management/)
- [AVM Opcodes](../advanced/opcodes/)
