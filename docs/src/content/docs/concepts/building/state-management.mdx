...
description: Validate global, local, box, and scratch state behavior in tests.
---
...
For more detailed information, explore the example contracts in the `examples/` directory, the [coverage](../advanced/coverage/) page, and the [API documentation](../../api/).
