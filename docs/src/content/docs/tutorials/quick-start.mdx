---
title: Quick Start
description: Get started with offline smart contract testing in minutes.
---
...
- [Testing Guide](../concepts/core/testing-guide/)
- [Examples](../examples/)
- [Coverage](../concepts/advanced/coverage/)
- [FAQ](../concepts/advanced/faq/)
- [API Reference](../api/)
- [Algorand TypeScript](../concepts/advanced/algorand-typescript/)
